...
data <- read.csv("/Users/tashakim/Movement-estimation-1/Pose_class_data/pose_class_2_threatening.csv")
```
...
write.csv(data, 'threatening_cleaned.csv')
```